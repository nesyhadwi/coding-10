!function() {
    ...
    , {
        "./shared/getEventType": 28,
        "./utils/addEventListener": 32
    }],
    24: [function(t, e, i) {
        "use strict";
    ...
    , {
        "./extend": 76,
        "@marcom/ac-polyfills/Array/isArray": 82
    }],
    74: [function(t, e, i) {
        "use strict";
        var n = function() {};
            ...
            if ("Element"in t) {
                ...
                i.defineProperty) {
                    ...
                    try {
                        ...
                        -2146823252 === t.number && (h.enumerable = !1,
                        i.defineProperty(e, "classList", h))
                    }
                } else
    ...
    , {
        "./ac-event-emitter/EventEmitter": 112,
        dup: 56
    }],
    112: [function(t, e, i) {
    ...
    113: [function(t, e, i) {
        ...
        e.exports = function t(e, i) {
            if (!(this instanceof t) && a)
                ...
                ;
            e = e || document;
            var c, l = Array.prototype.slice.call(e.querySelectorAll("[" + r + "]")), h = Array.prototype.slice.call(e.querySelectorAll("[" + o + "]"));
            if (l.length)
                ...
                for (var _ in u)
                    u.hasOwnProperty(_) && (c = s(u[_], Object.assign(i || {}, {
    ...
    137: [function(t, e, i) {
        ...
        class A extends a {
            constructor(t) {
                ...
                t.video ? this._videoElement = t.video : t.src instanceof HTMLVideoElement ? this._videoElement = t.src : this._textureSrc && (this._textureSrc.endsWith(".mp4") || this._textureSrc.endsWith(".m3u8") || this._textureSrc.endsWith(".webm")) && (this._videoElement = document.createElement("video")),
                this._flat = t.flat,
                this._maxLat = t.maxLat || v,
                this._pointerControls = new o({
            ...
            async _updateTexture(t) {
                await this._renderer.updateTexture(t),
                this.trigger("textureChange")
            }
            _onResize() {
                if (!window.THREE || !this._renderer)
                    return;
                let t, e;
            ...
            _respositionCameraToPosition(t, e) {
                ...
                t.lat === this.position.lat && t.lon === this.position.lon)
                    return this.trigger(A.ROTATION_START, {
                        time: 0,
                        startPosition: Object.assign({}, this.position),
                        targetPosition: Object.assign({}, this.position)
                    }),
                ...
                return this.trigger(A.ROTATION_START, f),
                new Promise(e=>{
    ...
    140: [function(t, e, i) {
        ...
        e.exports = class {
            ...
            _updateInertia() {
                ...
                this._inertiaRaf = n(this._updateInertia)) : (this._velocity = {
                    x: 0,
                    y: 0
                },
                r(this._inertiaRaf),
    ...
    141: [function(t, e, i) {
        ...
        e.exports = class {
            ...
            _onOrientation(t) {
                window.matchMedia("(orientation: portrait)").matches ? (this._lon = n(this._lon - t.rotationRate.beta * o),
                this._lat = this._lat - t.rotationRate.alpha * o) : t.orientation || -90 === window.orientation ? (this._lon = n(this._lon + t.rotationRate.alpha * o),
                this._lat = this._lat - t.rotationRate.beta * o) : (this._lon = n(this._lon - t.rotationRate.alpha * o),
    ...
    148: [function(t, e, i) {
        ...
        t("@marcom/ac-raf-emitter/cancelUpdate");
        e.exports = function(t, e) {
            let i, r = 0, o = !1, s = new Promise((i,s)=>{
    ...
    , {
        "./request": 158,
        "@marcom/ac-object/toQueryParameters": 215
    }],
    160: [function(t, e, i) {
        "use strict";
        var n = t("./request")
    ...
    163: [function(t, e, i) {
        "use strict";
        var n, r = t("@marcom/ac-object/extend"), o = t("@marcom/ac-object/create"), s = t("@marcom/ac-event-emitter-micro").EventEmitterMicro, a = t("@marcom/ac-dom-traversal/querySelectorAll"), c = t("@marcom/ac-dom-events/addEventListener"), l = t("@marcom/ac-dom-events/removeEventListener"), h = t("@marcom/ac-console");
        try {
            n = t("@marcom/ac-analytics")
        } catch (t) {
            h.log(t.message)
    ...
    , {
        "@marcom/ac-prefixer/getEventType": 223,
        dup: 28
    }],
    171: [function(t, e, i) {
    ...
    , {
        "./ac-event-emitter-micro/EventEmitterMicro": 191,
        dup: 54
    }],
    191: [function(t, e, i) {
    ...
    , {
        "./extend": 214,
        "@marcom/ac-polyfills/Array/isArray": 216,
        dup: 73
    }],
    213: [function(t, e, i) {
    ...
    , {
        "@marcom/ac-polyfills/Array/prototype.forEach": 218,
        dup: 76
    }],
    215: [function(t, e, i) {
    ...
    , {
        "@marcom/ac-url/joinSearchParams": 276,
        dup: 81
    }],
    216: [function(t, e, i) {
    ...
    240: [function(t, e, i) {
        "use strict";
        var n, r = "undefined" != typeof window ? window : {}, o = r.AC, s = (n = {},
        {
            get: function(t, e) {
                var i = null;
    ...
    241: [function(t, e, i) {
        ...
        _._addEventListeners = function() {
            ...
            this._keyboard.onDown(a.num, this.stepDown)) : (this._keyboard.onDown(h.num, this.stepDown),
        ...
        _._removeEventListeners = function() {
            ...
            this._keyboard.offUp(l.num, this._triggerRelease)) : (this._keyboard.offDown(h.num, this.stepDown),
    ...
    , {
        "./Dialog": 252,
        "./copy-actions/CopyToClipboard": 257
    }],
    257: [function(t, e, i) {
        "use strict";
    ...
    297: [function(t, e, i) {
        ...
        var R = function(e) {
            function i(t) {
                ...
                e._isResponsive && (e._breakpointDetect = new L({
                    el: e.el,
                    player: e,
                    breakpoints: T,
                    addClass: !0
                ...
                (t.poster || void 0 === t.poster) && (e._initPoster(t.poster),
                t.autoplay || void 0 === t.preload || "none" !== t.preload && "metadata" !== t.preload && !1 !== t.preload || e._poster.show()),
                e._bindMethods(),
                e._addEventListeners(),
                b && (e._keyboardControl = P({
                    player: e,
            ...
            o(i, [{
                ...
                value: function() {
                    ...
                    b ? (p.on("enterfullscreen", this._forwardEnterFullScreenEvent),
                    ...
                    this.on("fullscreen:change", this._onFullscreenChange)) : w && (this._videoImpl.on("webkitbeginfullscreen", this._forwardEnterFullScreenEvent),
                ...
                value: function() {
                    ...
                    b ? (p.off("enterfullscreen", this._forwardEnterFullScreenEvent),
                    p.off("exitfullscreen", this._forwardExitFullScreenEvent),
                    p.off("enterfullscreen", this._forwardFullScreenChangeEvent),
                    p.off("exitfullscreen", this._forwardFullScreenChangeEvent)) : w && (this._videoImpl.off("webkitbeginfullscreen", this._forwardEnterFullScreenEvent),
                ...
                value: function(t, e, i, n) {
                    ...
                    this.once("play", this._onPlay),
                    (this.options.autoplay && b || this.getEnded()) && this.once("loadstart", function() {
                        this.play()
                    }
                    .bind(this)),
                    n || (n = this.options),
                ...
                value: function() {
                    ...
                    b ? this.el.appendChild(this._blockade.el) : (this.controls.el.classList.add("mobile"),
                ...
                value: function(e) {
                    ...
                    e && !C ? this.el.classList.add("ac-video-live-dvr") : k && (this._captionRemovalInterval = setInterval(function() {
                ...
                value: function(t) {
                    ...
                    if (this._started)
                        S("ERROR: an error occured during playback, but we'll try to recover. Error code " + (e ? e.message : "unknown"));
          ...
          , l = function(t) {
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "play", this).apply(this, arguments)
                }
            }, {
                key: "_bindMethods",
                value: function() {
    ...
    311: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            return t.filter(function(t) {
                return !(e.has(t.language) || "subtitles" !== t.kind && "captions" !== t.kind && t.kind) && (e.add(t.language),
                !0)
            })
        }
    }
    ...
    313: [function(t, e, i) {
        ...
        _._updateAxTracksSelector = function() {
            ...
            !t && e ? (this.tracksSelectorContainer.classList.add("no-captions"),
            this.captionsSelectorContainer.classList.add("hidden")) : t && (this.tracksSelectorContainer.classList.remove("no-captions"),
        ...
        _._initUIComponents = function(t) {
            ...
            c && t.enableMainControls && (this.overlays = new l({
                ...
                value: function() {
                    ...
                    var e = Array.from(t).map(function(t) {
                        var e = t.enabled
                          ...
                          , s = o[t.language]
                          , a = t.label;
                        a || (a = "description" === t.kind ? s ? o[t.language] + " Audio Descriptions" : "Audio Descriptions (" + t.language + ")" : s ? o[t.language] : t.language);
                        var c = {
                            enabled: e,
                            id: i,
                            kind: n,
          ...
          , l = function(t) {
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    e.length || t.length > 1 ? this._view.setState("on") : i.length ? this._view.setState("off") : this._view.setState("initial")
                }
            }, {
                key: "_addPlayerListeners",
                value: function() {
                ...
                value: function() {
                    ...
                    e.length > 1 && this._allowMultiLanguageCaptions || i.length > 1 ? this._player.isCaptionsSelectorShowing() ? this._player.hideCaptionsSelector() : this._player.showCaptionsSelector() : 1 === t.length ? (e[0].mode = "hidden",
                    s.setItem("cc-disabled", !0)) : (e[0].mode = "showing",
                    s.removeItem("cc-disabled")),
          ...
          , p = function(t) {
            ...
            n(e, [{
                ...
                value: function() {
                    var t = this
                      ...
                      , i = h(this._player.getTextTracks()).map(function(i) {
                        ...
                        ("showing" === i.mode || r.length && r.some(function(t) {
                            return "showing" === t.mode
                        })) && (e = !1);
                        var s = {
                ...
                value: function(t) {
                    ...
                    e.language !== r ? (e.enabled = !0,
                    d.removeItem("cc-disabled")) : d.setItem("cc-disabled", !0),
            ...
            n(e, [{
                ...
                value: function(t) {
                    ...
                    t.forEach(function(t) {
                        ...
                        t.enabled ? (n.classList.add("enabled"),
    ...
    , {
        "../chapters/ChapterView": 332,
        "@marcom/ac-slider": 242
    }],
    343: [function(t, e, i) {
        "use strict";
        var n = function() {
    ...
    383: [function(t, e, i) {
        ...
        e.exports = {
            getVideoSource: function(t, e, i, a) {
                ...
                var g, b = l[0].width, E = a && a.maxWidth ? Math.max(a.maxWidth, b) : h;
                if (!t)
          ...
          , u = function(t) {
            ...
            n(e, [{
                ...
                value: function() {
                    ...
                    r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "destroy", this).call(this),
                    this._hls && (this._hls.off(o.Events.AUDIO_TRACK_SWITCHED, this._forwardAudioTrackChangeEvent),
        ...
        var r = t("../dom-emitter/DOMEmitterMicro")
          ...
          , l = function(t) {
            function e(t) {
                ...
                n.el.audioTracks && (n.el.audioTracks.addEventListener("addtrack", n._forwardAudioTrackChangeEvent),
          ...
          , o = function() {
            ...
            return n(t, [{
                ...
                value: function() {
                    ...
                    .bind(this)),
                    this._loadOnInit && (this.load.apply(this, function(t) {
                        if (Array.isArray(t)) {
