...
function _iterableToArrayLimit(e, t) {
    var r = []
      ...
      , o = void 0;
    try {
        for (var n, s = e[Symbol.iterator](); !(a = (n = s.next()).done) && (r.push(n.value),
        !t || r.length !== t); a = !0)
            ;
    } catch (e) {
        i = !0,
...
require = function() {
    ...
    2: [function(e, t, r) {
        ...
        t.exports = function(e) {
            return function() {
                if (a && "object" === _typeof(window.console) && "function" == typeof console[e])
          ...
          , n = function() {
            ...
            return _createClass(e, [{
                ...
                value: function(e) {
                    ...
                    i("Data Relay - click occurred - looking for ancestor that has data-rid-relay or data-rid-store"),
                    t && (t.getAttribute(this.properties.ridRelayAttribute) ? (i("Data Relay - an element with data-rid-relay was clicked"),
                    this._handleRidRelay(e, t)) : t.getAttribute(this.properties.ridStoreAttribute) && (i("Data Relay - an element with data-rid-store was clicked"),
                ...
                value: function(e) {
                    if (e) {
                        ...
                        t ? (i("Data Relay - cookie was already there, combining the new data with the current cookie data"),
                        i("Data Relay - current data stored in cookie", t),
                        i("Data Relay - the rid that is currently in the URL that is overwriting the current rid", e),
                        i("Data Relay - the combined value of the old and new rid data"),
                        this.writeCookieFromObj(this._prepareCookieData(e, t))) : (i("Data Relay - cookie was not already there - just created now"),
                        i('Data Relay - wrote the following string to the cookie:"', JSON.stringify(e) + '"'),
                ...
                value: function(e, t) {
                    ...
                    if (r) {
                        ...
                        o ? a = this.relayDataToElement(t, r, o) : i("Data Relay - no cookie data applied, there was no data stored in the cookie"),
                        a || (a = this.getTrackingDataForEl(t, r)),
                        a && this._trackAnalyticsData(t, a, r, e)
                    } else
                        i("Data Relay - no action taken, there was no proper data mapping")
                }
            }, {
                key: "_handleRidStore",
                value: function(e, t) {
                    var r = this.getRidStorageDataFromEl(t);
                    r ? (i("Data Relay - rid storage data found in element - attempting to store"),
                    this.storeRid(r)) : i("Data Relay - no action taken, there was no proper data in the rid store attribute")
                }
            }, {
                key: "_trackAnalyticsData",
                value: function(e, t, r, a) {
                    if (i("Data Relay - analytics tracking - " + this.properties.trackingProperty + ' should be tracked with the value "', t + '"'),
                    this.analytics) {
                        ...
                        this.options.canDeferNavigation && "A" === e.tagName && !this._isIntraPageLink(e) && (a.preventDefault(),
                ...
                value: function(e, t, r) {
                    ...
                    return o[a.trackingProperty || this.properties.trackingProperty] = t,
                    o
                }
            }, {
                ...
                value: function(e, t) {
                    ...
                    return n.forEach(function(e) {
                        ...
                        r.length < 1)
                            i("Data Relay - there was no data available in the elements url that corresponds to the rid to query param mapping, so this data will not be tracked on " + a.properties.trackingProperty);
                        else {
                            var n = new Set(r);
                    ...
                    i('Data Relay - built the data for a link that had no data relayed to it, the current value of "' + o + '" will be tracked on ' + this.properties.trackingProperty),
                    ...
                    return o.forEach(function(o) {
                        ...
                        s.forEach(function(s) {
                            if (s + ""in r) {
                                ...
                                var u = c.toString();
                                l.relative && (u = u.replace(a.properties.urlFormatHostName, l.original)),
                                e.setAttribute(o, decodeURIComponent(u)),
                                i('Data Relay - the data-url of the element had the query string named "' + t[s] + '" and the value of it was replaced with ' + r[s] + ' rid - "' + s + '"')
                            }
                        })
                    }),
                ...
                value: function(e) {
                    ...
                    return this._deleteInvalidValues(t),
                    !this._isEmpty(t) && t
                }
            }, {
                key: "getRidFromUrl",
                value: function(e) {
                    var t = this.getQueryString(e)
                      ...
                      , a = {};
                    if (r && (a = this._parseRidStringData(r)),
                    this.options.trackCid) {
                        var i, o = t[this.properties.cidQueryParam];
                        o && (i = this._parseCidStringData(o)),
                        i && Object.assign(a, i)
                    }
                    return this._isEmpty(a) && (a = null),
                    a
                }
            }, {
                key: "getRelayData",
                value: function(e, t, r, a) {
                    ...
                    e.forEach(function(e, r) {
                        if (!(e.length > i.properties.prefixMaxLength || !i.properties.prefixAllowedCharacters.test(e))) {
                            if (!o || void 0 === o[e] || i.properties.dataMaxLength < o[e].length || !i.properties.valueAllowedCharacters.test(o[e])) {
                                if (!t[r] || i.properties.dataMaxLength < t[r].length || !i.properties.valueAllowedCharacters.test(t[r]))
                                    return;
                                n.add(t[r])
                            } else
                                n.add(o[e]);
                    ...
                    return this.analytics && r && t && l[this.properties.trackingProperty] && l.events && (a ? this.analytics.passiveTracker(l, this.passiveTracking) : (l.title = this.properties.analyticsTitle,
                ...
                value: function(e) {
                    ...
                    return t.split(this.properties.urlSeparator).forEach(function(e) {
                        ...
                        if (i && i.length <= r.properties.prefixMaxLength && r.properties.prefixAllowedCharacters.test(i)) {
                            ...
                            r.properties.valueAllowedCharacters.test(o) && (a[i] = o)
                        }
                    }),
                    a
                }
